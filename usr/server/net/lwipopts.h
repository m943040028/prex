#ifndef _PREX_LWIP_LWIPOPTS_H_
#define _PREX_LWIP_LWIPOPTS_H_
...
/* at least as big as TCP_SND_QUEUELEN */
...
#define MEM_SIZE		\
	(PER_TCP_PCB_BUFFER*MEMP_NUM_TCP_SEG + 4096*MEMP_NUM_TCP_SEG)
